...
// Remote  Src  Dst
//
func (pkt *PacketBase) MatchesRemoteAddress(endpoint bool, protocol IPProtocol, network net.IPNet, port uint16) bool {
...
func (pkt *PacketBase) MatchesRemoteIP(endpoint bool, network net.IPNet) bool {
	if pkt.Direction != endpoint {
		if network.Contains(pkt.Src) {
			return true
		}
...
type Packet interface {
	...
	// MATCHING
	MatchesRemoteAddress(bool, IPProtocol, net.IPNet, uint16) bool
	MatchesRemoteIP(bool, net.IPNet) bool
